#
# Be sure to run `pod lib lint LSJHClearCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'LSJHClearCache'
  s.version          = '0.2.0'
  s.summary          = 'A short description of LSJHClearCache.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'LSJHClearCache' => ['LSJHClearCache/Assets/*.png']
  # }
